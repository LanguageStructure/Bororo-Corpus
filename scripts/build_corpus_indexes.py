...
def morphology_data():
 ...
 return {'fonte_conllu':str(CONLLU.relative_to(ROOT)),'segmentacao_inferida':False,'relacoes_lexicais':merge_relations(conllu_relations(CONLLU),conllu_relations(DICT_CONLLU)),'morfemas_conllu':enrich_morphemes(conllu_morphemes(CONLLU)),'analises_editoriais':editorial}
